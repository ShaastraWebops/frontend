			...
			<div class="row">
				<div class="col-md-5 col-md-offset-1">
					<div class="panel-group" id="accordion" id="myCarousel" >
                        ...
                        <div id="collapseFour" class="panel-collapse collapse background in">
				...
				<div class="col-md-5 svg-wrapper">
					<h2 class="text-center" style="position: absolute; top: 7.5%; text-align: center; width: 100%;">
			      	...
			      	<div class="animation anim-sampark">
						<svg id="samparkMap" xmlns="http://www.w3.org/2000/svg"
							...
							width="500" height"500" viewBox="0 0 750 750">
							<path
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
                $(window).resize(function() {
                    var h = $(window).height(), w = $('.svg-wrapper').width()
                    $('svg').css({
                        height : ( (h > w)?w:h ),
                        width : ( (h > w)?w:h ),
                    })
