...
<head>
    ...
    <style>
        ...
        .animation.sampark>svg#indianMap{
            /*height: 100%;*/
...
<body>
    ...
    <div class="animation sampark"
        style="position:fixed; z-index: -1; overflow: hidden; width: 100%; top:0%; left:0%;display:none" align="center">
        <svg    id="samparkMap"
            width="620"
            height="740"
        ...
        $(document).ready(function() {
            $(".category-link").click(function(ev) {
                ...
                if( $el.hasClass("aerofest")) {
                    ...
                    //----------------location animation
                    function locationAnimate(coord, name){
