...
<form method="post" action='save.php'>
      <p style='background-color : #cccccc;'>
         My Editor:<br />
         <textarea name="data" id='data'><?php echo $data; ?></textarea>
         <script type="text/javascript">
            CKEDITOR.inline( 'data' );
         </script>
      </p>
      <p>
         <input name="fname" type="hidden" value='sample.html' />
...
<hr>
<footer style='text-align:center'> 2015 Shaastra Webops </footer>
