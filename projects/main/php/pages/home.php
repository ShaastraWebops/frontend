        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 style="text-align:center;" class="modal-title" id="myModalLabel">Which field would you like speakers of the Shaastra Lecture Series to be from ?</h4>
                </div>
                <div id="poll_modal_body" style="margin-left:35%;" class="modal-body">
                    <input type="radio" id="option_one" value="tech_n_research" onclick="poll_save(this.value)">
                    <label for="option_one">Technology and Research</label>
                    <br />
                    <input type="radio" id="option_two" value="business_n_entrepreneurship" onclick="poll_save(this.value)">
                    <label for="option_two">Business and entrepreneurship</label>
                    <br />
                    <input type="radio" id="option_three" value="sports" onclick="poll_save(this.value)">
                    <label for="option_three">Sports</label>
                    <br />
                    <input type="radio" id="option_four" value="entertainment" onclick="poll_save(this.value)">
                    <label for="option_four">Entertainment</label>
                    <br />
                    <input type="radio" id="option_five" value="politics" onclick="poll_save(this.value)">
                    <label for="option_five">Politics</label>
                    <br />
                    <input type="radio" id="option_six" value="other" onclick="poll_save(this.value)">
                    <label for="option_six">Any other</label>
                </div>
