		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-5 col-md-offset-1">
					<div class="para1">
						<?php
							$data = file_get_contents('../../php/misc/pre-shaastra1.html');
							if ( isset($_GET['edit']) ) { ?>
							<form method="post" action='../../php/scripts/save_to_file.php'>
			                    <div class='data col-xs-12'>
			                        <input type='hidden' name='filename' value='../../php/misc/pre-shaastra1.html' />
			      	...
			      	<div class="animation anim-sampark">
						<svg id="samparkMap" xmlns="http://www.w3.org/2000/svg"
							...
							<path
							   ...
							   id="indianMap"/>
							<g class="cities">
								<!-- <a xlink:href="../../php/pages/event.php?category=Sampark&event=Mumbai" class="">
									<circle cx="100" cy="400" r="4"/>
			        				<text x="110" y="400" font-size="20">MUMBAI</text>
			    				</a>
			    				 <a xlink:href="../../php/pages/event.php?category=Sampark&event=Chennai" class="">
									<circle cx="250" cy="625" r="4"/>
			        				<text x="260" y="625" font-size="20">CHENNAI</text>
			    				</a>
			    				--><a xlink:href="../../php/pages/event.php?category=Sampark&event=Pune" class="">
									<circle cx="100" cy="430" r="4"/>
			        				<text x="110" y="430" font-size="20">PUNE</text>
			    				</a>
			    				<a xlink:href="../../php/pages/event.php?category=Sampark&event=Bangalore" class="">
									<circle cx="180" cy="630" r="4"/>
			        				<text x="60" y="625" font-size="20">BANGALORE</text>
			    				</a>

<!-- 			    				<a xlink:href="../../php/pages/event.php?category=Sampark&event=Vishakapatnam" class="">
									<circle cx="300" cy="510" r="4"/>
			        				<text x="310" y="510" font-size="20">VISHAKAPATNAM</text>
			    				</a>
 -->
 			    				<a xlink:href="../../php/pages/event.php?category=Sampark&event=Madhurai" class="">
									<circle cx="210" cy="685" r="4"/>
			        				<text x="220" y="685" font-size="20">MADHURAI</text>
			    				</a>

 				    			<a xlink:href="../../php/pages/event.php?category=Sampark&event=Hyderabad" class="">
									<circle cx="200" cy="550" r="4"/>
			        				<text x="210" y="550" font-size="20">HYDERABAD</text>
			    				</a>
			    				<a xlink:href="../../php/pages/event.php?category=Sampark&event=Coimbatore" class="">
									<circle cx="200" cy="660" r="4"/>
			        				<text x="210" y="660" font-size="20">COIMBATORE</text>
			    				</a>
			    				<a xlink:href="../../php/pages/event.php?category=Sampark&event=Kochi" class="">
					...
					<div class="para2">
						<?php
							$data = file_get_contents('../../php/misc/pre-shaastra2.html');
							if ( isset($_GET['edit']) ) { ?>
							<form method="post" action='../../php/scripts/save_to_file.php'>
			                    <div class='data2 col-xs-12'>
			                        <input type='hidden' name='filename' value='../../php/misc/pre-shaastra2.html' />
