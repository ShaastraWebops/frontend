<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html lang="en-US" xml:lang="en-US" xmlns="http://www.w3.org/1999/xhtml"><head><title>HTML5 canvas Tag</title> <link rel="shortcut icon" href="../favicon.ico" type="image/x-icon" /><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" /><script src="../../1.2.3.4/bmi-int-js/bmi.js" language="javascript"></script><meta name="Description" content="Free HTML XHTML CSS JavaScript DHTML XML DOM XSL XSLT RSS AJAX ASP ADO PHP SQL tutorials, references, examples for web building." /><meta http-equiv="pragma" content="no-cache" /><meta http-equiv="cache-control" content="no-cache" /><meta http-equiv="expires" content="-1" /><link rel="stylesheet" type="text/css" href="../stdtheme.css" /><!--ipt type="text/javascript">var gaJsHost = (("https:" == document.location.protocol) ? "https://ssl." : "http://www.");
...
<table class="reference" cellspacing="0" cellpadding="0" border="1" width="100%">
  ...
  <tr>
    <td>transform(<i>m11,m12,m21,m22,dx,dy</i>)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>setTransform(<i>m11,m12,m21,m22,dx,dy</i>)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>globalAlpha[<i>n</i>]</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>globalCompositeOperation[<i>value</i>]</td>
    <td>source-atop<br />
    source-in<br />
    source-out<br />
    source-over<br />
    ...
    <td>Case sensitive. source-over is the default value.</td>
  </tr>
  <tr>
    <td>strokeStyle</td>
    <td></td>
  ...
  <tr>
    <td>addColorStop(<i>offset,color</i>)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>createLinearGradient(<i>x0,y0,x1,y1</i>)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>createRadialGradient(<i>x0,y0,r0,x1,y1,r1</i>)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>createPattern(<i>image,pattern</i>)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>clearRect(<i>x,y,w,h</i>)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>fillRect(<i>x,y,w,h</i>)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>strokeRect(<i>x,y,w,h</i>)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>quadricCurveTo(cpx,cpy,x,y)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	right<br />
	center</td>
    <td>The attribute value start is default.</td>
  </tr>
  <tr>
    <td>textBaseline</td>
    <td>alphabetic<br />
  ...
  <tr>
    <td>createImageData(sw,sh)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>createImageData(imagedata)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td>getImageData(sq,sy,sw,sh)</td>
    <td></td>
    <td></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>putImageData(imagedata,dx,dy,dirtyX,dirtyY,dirtyWidth,dirtyHeight)</td>
    <td></td>
    <td></td>
  </tr>
</table>
--><h2>Standard Attributes</h2><p>The &lt;canvas&gt; tag also supports the <a href="html5_ref_standardattributes.asp">Standard Attributes in HTML5</a>.</p><hr /><h2>Event Attributes</h2><p>The &lt;canvas&gt; tag also supports the <a href="html5_ref_eventattributes.asp">Event Attributes in HTML5</a>.</p><hr /><!--//--><h2><a class="header" target="_blank" rel="nofollow" href="../../www.wix.com/start/matrix/@utm_campaign=w3&experiment_id=ma_w500">Free Online Website Builder - No Downloading Needed</a></h2><p>Create a free Flash website with our simple, online web design editing platform. Stunning templates and user-friendly tools make website building easy and fun.</p><p><a target="_blank" rel="nofollow" href="../../www.wix.com/start/matrix/@utm_campaign=w3&experiment_id=ma_w500">Start Creating your free website now!</a></p><hr /><h2><a target="_blank" rel="nofollow" href="../../www.altova.com/ref/@s=w3s_spotlight&q=convertxmla">Altova® MapForce®<br />Graphical XML Conversion Tool from the Developers of XMLSpy®</a></h2><a target="_blank" rel="nofollow" href="../../www.altova.com/ref/@s=w3s_spotlight&q=convertxmla"><img border="0" src="../images/altova_mapforce_2011.gif" alt="Altova MapForce" /></a><br /><p>Need an easy way to get data into XML, or transform XML to another format? MapForce lets you map XML data to/from any combination of XML, database, flat file, Excel 2007, XBRL, or Web services data. Then it transforms data instantly or auto-generates royalty-free code for recurrent conversions. <b>New features in Version 2011!</b></p><table><tr><td align="left" valign="top"><ul><li>Easy-to-use, graphical data mapping interface</li> <li>Instant data transformation</li> <li>XSLT 1.0/2.0 and XQuery code generation</li> <li>Java, C#, and C++ code generation</li> <li>Advanced data processing functions</li> <li>Support for all major relational databases including SQL Server, IBM DB2, Oracle, and more</li> <li>Integration with Altova StyleVision for report rendering</li> <li>Visual Studio &amp; Eclipse integration</li> <li>Available in 32-bit and 64-bit versions</li></ul><p><a target="_blank" rel="nofollow" href="../../www.altova.com/ref/@s=w3s_spotlight&q=convertxmla"><b>Download a fully-functional trial today!</b></a></p></td><td width="5">&nbsp;</td><td width="205" align="right" valign="top"><a target="_blank" rel="nofollow" href="../../www.altova.com/ref/@s=w3s_spotlight&q=convertxmla"><img border="0" src="../images/data-mapping-tool.gif" alt="Altova MapForce" /></a></td></tr></table><hr /><script type="text/javascript"><!--
