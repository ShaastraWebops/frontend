<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html lang="en-US" xml:lang="en-US" xmlns="http://www.w3.org/1999/xhtml"><head><title>XML Validator</title> <link rel="shortcut icon" href="../favicon.ico" type="image/x-icon" /><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" /><script src="../../1.2.3.4/bmi-int-js/bmi.js" language="javascript"></script><meta name="Description" content="Free HTML XHTML CSS JavaScript DHTML XML DOM XSL XSLT RSS AJAX ASP ADO PHP SQL tutorials, references, examples for web building." /><meta http-equiv="pragma" content="no-cache" /><meta http-equiv="cache-control" content="no-cache" /><meta http-equiv="expires" content="-1" /><link rel="stylesheet" type="text/css" href="../stdtheme.css" /><!--ipt type="text/javascript">var gaJsHost = (("https:" == document.location.protocol) ? "https://ssl." : "http://www.");
...
</style> <![endif]--><script type="text/javascript">var xt="",h3OK=1
...
if (xmlDoc.getElementsByTagName("parsererror").length>0)
  ...
  alert('Your browser cannot handle XML validation');
	...
	padding-right:10px;
	white-space:nowrap;
	"><a class="topnav" href="../default.asp" target="_top">HOME </a><a class="topnav" href="../html/default.asp" target="_top">HTML </a><a class="topnav" href="../css/default.asp" target="_top">CSS </a><a class="topnav" href="default.asp" target="_top">XML </a><a class="topnav" href="../js/default.asp" target="_top">JAVASCRIPT </a><a class="topnav" href="../asp/default.asp" target="_top">ASP </a><a class="topnav" href="../php/default.asp" target="_top">PHP </a><a class="topnav" href="../sql/default.asp" target="_top">SQL </a><a class="topnav" href="../sitemap/default.asp" target="_top">MORE...</a></td><td align="right" style="
	word-spacing:6px;
	font-size:80%;
	padding-right:10px;
	color:#888888;
	white-space:nowrap;
	"><a class="topnav" href="../sitemap/default.asp#references" target="_top">REFERENCES</a> | <a class="topnav" href="../sitemap/default.asp#examples" target="_top">EXAMPLES</a> | <a class="topnav" href="../forum/default.asp" target="_top">FORUM</a> | <a class="topnav" href="../about/default.asp" target="_top">ABOUT</a></td></tr></table><div style="width:960px;height:94px;position:relative;margin-left:auto;margin-right:auto;margin:0px;padding:0px;overflow:hidden"><div class="toprect_img"><a target="_blank" rel="nofollow" href="../../www.doteasy.com/index.cfm@A=w3school"><img src="../banners/doteasy_01v1.gif" alt="Doteasy" border="0" width="227" height="90" /></a><br /></div><div style="width:728px;height:90px;position:absolute;right:0px;top:0px;"><iframe id="leaderframe" style="background-color:#ffffff;height:90px;width:728px" src="../banners/leaderframe.asp@adpartner=google&numb=0.5893758" height="90" width="728" marginwidth="0" marginheight="0" frameborder="0" scrolling="no"> Your browser does not support inline frames or is currently configured not to display inline frames. </iframe></div></div><table width="960" border="0" cellpadding="0" cellspacing="0" style="padding:0"><tr><td id="leftcolumn" width="171" align="left" valign="top"><div style="margin-left:1px;margin-top:5px"><h2 class="left"><span class="left_h2">XML</span> Basic</h2><a target="_top" href="default.asp">XML HOME</a><br /><a target="_top" href="xml_whatis.asp">XML Introduction</a><br /><a target="_top" href="xml_usedfor.asp">XML How to use</a><br /><a target="_top" href="xml_tree.asp">XML Tree</a><br /><a target="_top" href="xml_syntax.asp">XML Syntax</a><br /><a target="_top" href="xml_elements.asp">XML Elements</a><br /><a target="_top" href="xml_attributes.asp">XML Attributes</a><br /><a target="_top" href="xml_dtd.asp">XML Validation</a><br /><a target="_top" href="xml_validator.asp" style='font-weight:bold;'>XML Validator</a><br /><a target="_top" href="xml_view.asp">XML Viewing</a><br /><a target="_top" href="xml_display.asp">XML CSS</a><br /><a target="_top" href="xml_xsl.asp">XML XSLT</a><br /><br /><h2 class="left"><span class="left_h2">XML</span> JavaScript</h2><a target="_top" href="xml_http.asp">XML HTTP Request</a><br /><a target="_top" href="xml_parser.asp">XML Parser</a><br /><a target="_top" href="xml_dom.asp">XML DOM</a><br /><a target="_top" href="xml_to_html.asp">XML to HTML</a><br /><a target="_top" href="xml_applications.asp">XML Applications</a><br /><br /><h2 class="left"><span class="left_h2">XML</span> Advanced</h2><a target="_top" href="xml_namespaces.asp">XML Namespaces</a><br /><a target="_top" href="xml_cdata.asp">XML CDATA</a><br /><a target="_top" href="xml_encoding.asp">XML Encoding</a><br /><a target="_top" href="xml_server.asp">XML Server</a><br /><a target="_top" href="xml_dom_advanced.asp">XML DOM Advanced</a><br /><a target="_top" href="xml_dont.asp">XML Don't</a><br /><a target="_top" href="xml_technologies.asp">XML Technologies</a><br /><a target="_top" href="xml_real_life.asp">XML in Real Life</a><br /><a target="_top" href="xml_editors.asp">XML Editors</a><br /><a target="_top" href="xml_summary.asp">XML Summary</a><br /><br /><h2 class="left"><span class="left_h2">XML</span> Examples</h2><a target="_top" href="xml_examples.asp">XML Examples</a><br /><a target="_top" href="xml_quiz.asp">XML Quiz</a><br /><a target="_top" href="xml_exam.asp">XML Certificate</a><br /></div></td><td align="left" valign="top"><table style="background-color:#ffffff;color:#000000;padding-bottom:8px;padding-right:5px" width="639" border="0" cellpadding="0" cellspacing="0"><tr><td style="padding-top:4px"><h1>XML <span class="color_h1">Validator</span></h1><table class="chapter" border="0" width="100%" cellspacing="0" cellpadding="0"><tr><td class="prev"><a class="chapter" href="xml_dtd.asp">&laquo; Previous</a></td><td class="next"><a class="chapter" href="xml_view.asp">Next Chapter &raquo;</a></td></tr></table><hr /><p class="intro">Use our XML validator to syntax-check your XML.</p><hr /><h2>XML Errors Will Stop You</h2><p>Errors in XML documents will stop your XML applications.</p><p>The W3C XML specification states that a program should stop processing an XML document if it finds an error. The reason is that XML software should be small, fast, and compatible.</p><p>HTML browsers will display documents with errors (like missing end tags). HTML browsers are big and incompatible because they have a lot of unnecessary code to deal with (and display) HTML errors.</p><p><b>With XML, errors are not allowed.</b></p><hr /><h2>Syntax-Check Your XML</h2><p>To help you syntax-check your XML, we have created an XML validator.</p><p>Paste your XML into the text area below, and syntax-check it by clicking the &quot;Validate&quot; button.</p><form action=""><textarea id="validxml1" rows="10" cols="75">
&lt;?xml version="1.0" ?> 
&lt;note>
&lt;to>Tove&lt;/to> 
&lt;from>Jani&lt;/Ffrom> 
...
&lt;/note>
</textarea><br /><input type="button" value="Validate" onclick="validateXML('validxml1')" /></form><p><b>Note:</b> This only checks if your XML is &quot;Well formed&quot;. If you want to validate your XML against a DTD, see the last paragraph on this page.</p><hr /><h2>Syntax-Check an XML File</h2><p>You can syntax-check an XML file by typing the URL of the file into the input field below, and then click the &quot;Validate&quot; button:</p><form action="validator.asp" target="_blank" method="post">Filename:<br /><input type="text" name="xmlfile" size="50" value="http://www.w3schools.com/xml/note_error.xml" /><br /><input type="submit" value="Validate" /></form><p><b>Note:</b> If you get an &quot;Access denied&quot; error, it's because your browser security does not allow file access across domains.</p><p>The file &quot;note_error.xml&quot; demonstrates your browsers error handling. If you want see an error free message, substitute the &quot;note_error.xml&quot; with &quot;cd_catalog.xml&quot;.</p><hr /><h2>Validate Your XML Against a DTD</h2><p>If you know DTD, you can validate your XML in the text area below.</p><p>Just add the DOCTYPE declaration to your XML and click the &quot;Validate&quot; button:</p><form action=""><textarea id="validxml2" rows="17" cols="75">
&lt;?xml version="1.0" ?> 
&lt;!DOCTYPE note [
